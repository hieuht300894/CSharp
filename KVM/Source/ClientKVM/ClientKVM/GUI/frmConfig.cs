...
namespace ClientKVM.GUI
{
    public partial class frmConfig : frmBase
    {
        ...
        void LoadConfig()
        {
            ...
            txtConfigExe.Text = config.ConfigExe;
            txtConfigFile.Text = config.ConfigFile;
            txtConfigFolder.Text = config.ConfigFolder;
            txtConfigLog.Text = config.ConfigLog;
        ...
        void SaveConfig()
        {
            ...
            clsGeneral.Config.ConfigExe = txtConfigExe.Text;
            clsGeneral.Config.ConfigFile = txtConfigFile.Text;
            clsGeneral.Config.ConfigFolder = txtConfigFolder.Text;
            clsGeneral.Config.ConfigLog = txtConfigLog.Text;
